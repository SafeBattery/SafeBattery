    ...
    <div className={styles.trendModalOverlay}>
      <div className={styles.trendModal}>
        ...
        <div className={styles.description}>
          ...
          <h4>1) Transformer란?</h4>
          <p>
            Transformer는 시계열 데이터 예측에 특화된 딥러닝 모델로, 효율적이고 정확한 예측을 지원합니다.
          </p>
          <h4>2) 모델 구성</h4>
          <p>
            PW와 U_totV는 하나의 멀티타스크 Transformer 모델에서 함께 예측되며, T_3 값은 별도의 Transformer 모델에서 개별적으로 예측됩니다.
          </p>
          <h4>3) 차트 해석법</h4>
          <img src={trendChart} alt="센서 데이터 및 상태 트렌드 차트" style={{ width: '70%', height: '50%' }} />
